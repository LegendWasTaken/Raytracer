...
public class VecUtils {
    ...
    public static Vec2 cross(Vec2 a, Vec2 b){ return new Vec2(a.x * b.x, b.y * b.y); }
    public static Vec2 abs(Vec2 a){ return new Vec2(Math.abs(a.x), Math.abs(a.y)); }
    public static Vec2 mod(Vec2 a, float mod){ return new Vec2(a.x % mod, a.y % mod); }
    ...
    public static Vec2 normalize(Vec2 a){ float t = (float) Math.sqrt(a.x * a.x + a.y * a.y); return new Vec2(a.x / t, a.y / t); }
    public static float dot(Vec3 a, Vec3 b){ return (a.x * b.x + a.y * b.y + a.z * b.z); }
    public static float length(Vec3 a){ return (float) Math.sqrt(a.x * a.x + a.y * a.y + a.z * a.z); }
    ...
    public static Vec3 cross(Vec3 a, Vec3 b){ return new Vec3(a.x * b.x, a.y * b.y, a.z * b.z); }
    public static Vec3 abs(Vec3 a){ return new Vec3(Math.abs(a.x), Math.abs(a.y), Math.abs(a.z)); }
    public static Vec3 mod(Vec3 a, float scale){ return new Vec3(a.x % scale, a.y % scale, a.z % scale); }
    ...
    public static Vec3 normalize(Vec3 a){ float t = (float) Math.sqrt(a.x * a.x + a.y * a.y + a.z * a.z); return new Vec3(a.x / t, a.y / t, a.z / t); }
}